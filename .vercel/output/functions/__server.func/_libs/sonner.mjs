...
const SuccessIcon = /* @__PURE__ */ React2.createElement(
  "svg",
  {
...
const WarningIcon = /* @__PURE__ */ React2.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 24 24",
...
const InfoIcon = /* @__PURE__ */ React2.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 20 20",
...
const ErrorIcon = /* @__PURE__ */ React2.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 20 20",
...
const CloseIcon = /* @__PURE__ */ React2.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "12",
        ...
        .then(async (response) => {
          ...
          if (isReactElementResponse) {
            ...
            const isExtendedResult =
              typeof promiseData === "object" && !React2.isValidElement(promiseData);
...
const Toast = (props) => {
  ...
  const heightIndex = React2.useMemo(
  ...
  return /* @__PURE__ */ React2.createElement(
    ...
    /* @__PURE__ */ React2.isValidElement(toast2.cancel)
      ? toast2.cancel
      : toast2.cancel && isAction(toast2.cancel)
        ...
        : null,
    /* @__PURE__ */ React2.isValidElement(toast2.action)
      ? toast2.action
...
const Toaster = /* @__PURE__ */ React2.forwardRef(function Toaster2(props, ref) {
  ...
  const [actualTheme, setActualTheme] = React2.useState(
    theme !== "system"
      ? theme
