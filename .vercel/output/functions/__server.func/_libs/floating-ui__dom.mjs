import {
  ...
  a as arrow$1,
  l as limitShift$1,
} from "./floating-ui__core.mjs";
import {
  z as isElement,
  k as getDocumentElement,
  s as getOverflowAncestors,
  i as getComputedStyle$1,
  A as isHTMLElement,
  a as createCoords,
  J as round,
  x as getWindow,
  E as isTopLayer,
  u as getParentNode,
  B as isLastTraversableNode,
  D as isTableElement,
  y as isContainingBlock,
  j as getContainingBlock,
  G as max,
  H as min,
  n as getNodeName,
  C as isOverflowElement,
  o as getNodeScroll,
  m as getFrameElement,
