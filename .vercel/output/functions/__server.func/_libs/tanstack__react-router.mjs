...
import {
  t as invariant,
  u as isDangerousProtocol,
  k as exactPathTest,
  F as removeTrailingSlash,
  s as hasKeys,
  g as deepEqual,
  m as functionalUpdate,
  B as BaseRootRoute,
  a as BaseRoute,
  w as isModuleNotFoundError,
  x as isNotFound,
  q as getScrollRestorationScriptForRouter,
  H as rootRouteId,
  A as isServer,
  y as isRedirect,
  d as createNonReactiveReadonlyStore,
  c as createNonReactiveMutableStore,
  R as RouterCore,
  j as escapeHtml,
  v as isInlinableStylesheet,
  n as getAssetCrossOrigin,
