...
import { a as createServerFn, T as TSS_SERVER_FUNCTION, b as getServerFnById } from "./server-5VHo_4WK.mjs";
...
function buildInstagramAuthUrl(appId) {
  ...
  const scope = "instagram_content_publish,pages_show_list,instagram_basic,pages_read_engagement,business_management";
...
}).parse(input)).handler(createSsrRpc("41383486c2fa86cede87f45c84053abfc0df7059bd8fe2d129ebf819231343c3"));
export {
  getMetaAppId as a,
