import { h, j as ae, R as Ze } from "./index-CDMAuvnc.js";
const Ie = (...e) =>
  e
  ...
  (
    ...
    h.createElement(
      "svg",
      {
        ...
        ...(!s && !Xe(u) && { "aria-hidden": "true" }),
        ...u,
      },
      [...l.map(([c, b]) => h.createElement(c, b)), ...(Array.isArray(s) ? s : [s])],
    ),
);
const st = (e, t) => {
  const o = h.forwardRef(({ className: r, ...n }, s) =>
    h.createElement(Je, {
      ref: s,
      iconNode: t,
      className: Ie(`lucide-${qe(ye(e))}`, `lucide-${e}`, r),
      ...n,
    }),
  );
  return ((o.displayName = ye(e)), o);
};
function xe(e, t) {
...
function at(...e) {
  return h.useCallback(Pe(...e), e);
}
var Qe = Symbol.for("react.lazy"),
  J = Ze[" use ".trim().toString()];
function eo(e) {
...
function oo(e) {
  const t = ro(e),
    o = h.forwardRef((r, n) => {
      let { children: s, ...l } = r;
      je(s) && typeof J == "function" && (s = J(s._payload));
      const u = h.Children.toArray(s),
        p = u.find(so);
      if (p) {
        ...
        return ae.jsx(t, {
          ...l,
          ref: n,
          children: h.isValidElement(c) ? h.cloneElement(c, void 0, b) : null,
        });
      }
...
var to = oo("Slot");
function ro(e) {
  const t = h.forwardRef((o, r) => {
    let { children: n, ...s } = o;
    if ((je(n) && typeof J == "function" && (n = J(n._payload)), h.isValidElement(n))) {
      const l = io(n),
        u = ao(s, n.props);
      return (n.type !== h.Fragment && (u.ref = r ? Pe(r, l) : l), h.cloneElement(n, u));
    }
...
function Ee(e) {
  ...
  if (typeof e == "string" || typeof e == "number") r += e;
    ...
    if (Array.isArray(e)) {
      var n = e.length;
      for (t = 0; t < n; t++) e[t] && (o = Ee(e[t])) && (r && (r += " "), (r += o));
...
const we = (e) => (typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e),
        ...
        t == null || (r = t.compoundVariants) === null || r === void 0
          ...
          : r.reduce((c, b) => {
              ...
              return Object.entries(R).every((N) => {
                let [w, k] = N;
                return Array.isArray(k) ? k.includes({ ...s, ...u }[w]) : { ...s, ...u }[w] === k;
              })
                ? [...c, g, z]
                : c;
            }, []);
    return ke(e, l, p, o?.class, o?.className);
  },
  co = (e, t) => {
  ...
  mo = (e, t) => ({ classGroupId: e, validator: t }),
  Le = (e = new Map(), t = null, o) => ({ nextPart: e, validators: t, classGroupId: o }),
  Q = "-",
  ve = [],
  uo = "arbitrary..",
  po = (e) => {
    ...
    return {
      getClassGroupId: (l) => {
        if (l.startsWith("[") && l.endsWith("]")) return fo(l);
        const u = l.split(Q),
          p = u[0] === "" && u.length > 1 ? 1 : 0;
        return Ne(u, p, t);
      },
  ...
  zo = (e) => {
    ...
    let r = (n) => {
      ...
      const g = s.length === 0 ? n : n.slice(p);
      let z = g,
        R = !1;
      g.endsWith(ie)
        ? ((z = g.slice(0, -1)), (R = !0))
        : g.startsWith(ie) && ((z = g.slice(1)), (R = !0));
      const N = c && c > p ? c - p : void 0;
      return ze(s, R, z, N);
    };
    if (t) {
      const n = t + Ce,
        s = r;
      r = (l) => (l.startsWith(n) ? s(l.slice(n.length)) : ze(Co, !1, l, void 0, !0));
    }
    if (o) {
      const n = r;
      ...
      (o) => {
        ...
        for (let s = 0; s < o.length; s++) {
          const l = o[s],
            u = l[0] === "[",
            p = t.has(l);
          u || p ? (n.length > 0 && (n.sort(), r.push(...n), (n = [])), r.push(l)) : n.push(l);
        }
  ...
  Po = (e, t) => {
    ...
    for (let b = p.length - 1; b >= 0; b -= 1) {
      ...
      const F = R.length === 0 ? "" : R.length === 1 ? R[0] : s(R).join(":"),
        _ = N ? F + ie : F,
        W = _ + A;
  ...
  jo = (...e) => {
    let t = 0,
      ...
      r,
      n = "";
    for (; t < e.length; ) (o = e[t++]) && (r = Te(o)) && (n && (n += " "), (n += r));
    return n;
  },
  Te = (e) => {
    ...
    let t,
      o = "";
    for (let r = 0; r < e.length; r++) e[r] && (t = Te(e[r])) && (o && (o += " "), (o += t));
    return o;
  },
  Eo = (e, ...t) => {
    let o, r, n, s;
    const l = (p) => {
        ...
        return ((o = So(c)), (r = o.cache.get), (n = o.cache.set), (s = u), u(p));
      },
      u = (p) => {
        const c = r(p);
        if (c) return c;
  ...
  Qo = () => {
    const e = y("color"),
      ...
      oe = () => [G, "screen", "full", "dvw", "lvw", "svw", "min", "max", "fit", ...d()],
      te = () => [G, "screen", "full", "lh", "dvh", "lvh", "svh", "min", "max", "fit", ...d()],
      m = () => [e, i, a],
      pe = () => [..._(), Re, Se, { position: [i, a] }],
      fe = () => ["no-repeat", { repeat: ["", "x", "y", "space", "round"] }],
      be = () => ["auto", "cover", "contain", Ho, Uo, { size: [i, a] }],
      re = () => [se, U, O],
      v = () => ["", "none", "full", c, i, a],
      C = () => ["", f, U, O],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: ["auto", "square", G, a, i, k] }],
        container: ["container"],
        "container-type": [{ "@container": ["", "normal", "size", i, a] }],
        "container-named": [Fo],
        columns: [{ columns: [f, a, i, u] }],
        ...
        z: [{ z: [P, "auto", i, a] }],
        basis: [{ basis: [G, "full", "auto", u, ...d()] }],
        "flex-direction": [{ flex: ["row", "row-reverse", "col", "col-reverse"] }],
        "flex-wrap": [{ flex: ["nowrap", "wrap", "wrap-reverse"] }],
        flex: [{ flex: [f, G, "auto", "initial", "none", a] }],
        grow: [{ grow: ["", f, i, a] }],
        shrink: [{ shrink: ["", f, i, a] }],
        ...
        "font-size": [{ text: ["base", o, U, O] }],
        "font-smoothing": ["antialiased", "subpixel-antialiased"],
        "font-style": ["italic", "not-italic"],
        "font-weight": [{ font: [r, Xo, Do] }],
        "font-stretch": [
          {
            "font-stretch": [
              "ultra-condensed",
        ...
        "line-clamp": [{ "line-clamp": [f, "none", i, Ae] }],
        leading: [{ leading: [s, ...d()] }],
        ...
        "outline-w": [{ outline: ["", f, U, O] }],
        "outline-color": [{ outline: m() }],
        shadow: [{ shadow: ["", "none", b, X, K] }],
        "shadow-color": [{ shadow: m() }],
        "inset-shadow": [{ "inset-shadow": ["none", g, X, K] }],
        ...
        "text-shadow": [{ "text-shadow": ["none", z, X, K] }],
        ...
        "drop-shadow": [{ "drop-shadow": ["", "none", R, X, K] }],
...
const tt = lo(
  ...
  rt = h.forwardRef(({ className: e, variant: t, size: o, asChild: r = !1, ...n }, s) => {
    const l = r ? to : "button";
    return ae.jsx(l, { className: ot(tt({ variant: t, size: o, className: e })), ref: s, ...n });
  });
rt.displayName = "Button";
export { rt as B, Pe as a, st as b, ot as c, oo as d, lo as e, at as u };
