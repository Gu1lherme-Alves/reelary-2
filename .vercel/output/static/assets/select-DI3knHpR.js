import { h as n, j as a, r as Re } from "./index-CDMAuvnc.js";
import {
  i as _,
  r as mt,
  q as Te,
...
import { b as Et, a as _t, u as L, c as G } from "./button-BCDv24mv.js";
...
function Ot(t) {
  const o = n.forwardRef((e, s) => {
    ...
    if (n.isValidElement(r)) {
      const l = kt(r),
        c = Vt(d, r.props);
      return (r.type !== n.Fragment && (c.ref = s ? _t(s, l) : l), n.cloneElement(r, c));
    }
...
var _e = Object.freeze({
  ...
  Ht = "VisuallyHidden",
  Wt = n.forwardRef((t, o) => a.jsx(_.span, { ...t, ref: o, style: { ..._e, ...t.style } }));
Wt.displayName = Ht;
var Ft = [" ", "Enter", "ArrowUp", "ArrowDown"],
  Ut = [" ", "Enter"],
  Q = "Select",
  [ie, de, Kt] = gt(Q),
  [oe] = St(Q, [Kt, Pe]),
  ...
  je = (t) => {
    const {
      ...
      [F, M] = n.useState(!1),
      ne = mt(p),
      [P, O] = Te({ prop: s, defaultProp: r ?? !1, onChange: d, caller: Q }),
      [U, Z] = Te({ prop: l, defaultProp: c, onChange: i, caller: Q }),
      V = n.useRef(null),
      ...
      children: a.jsx(_.button, {
        ...
        onKeyDown: N(r.onKeyDown, (u) => {
          ...
          (!(u.ctrlKey || u.altKey || u.metaKey) && u.key.length === 1 && R(u.key),
            !(h && u.key === " ") && Ft.includes(u.key) && (C(), u.preventDefault()));
        }),
      }),
    });
  });
  ...
  De = n.forwardRef((t, o) => {
    ...
    return (
      ...
      a.jsx(_.span, {
        ...
        children: ot(i.value) ? a.jsx(a.Fragment, { children: l }) : d,
      })
    );
  });
De.displayName = Oe;
...
var A = 10,
  ...
  Xt = At("SelectContent.RemoveScroll"),
  He = n.forwardRef((t, o) => {
    const {
        __scopeSelect: e,
    ...
    const E = n.useCallback(
        (f) => {
          const [I, ...j] = k().map((T) => T.ref.current),
            [w] = j.slice(-1),
          ...
          for (const T of f)
            if (
              ...
              T === I && M && (M.scrollTop = 0),
              T === w && M && (M.scrollTop = M.scrollHeight),
              T?.focus(),
        ...
        if (d.trigger && d.valueNode && c && p && u && h && S) {
          ...
          if (d.dir !== "rtl") {
            const y = Z.left - O.left,
              ...
              ve = Ne(T, [A, Math.max(A, ge - he)]);
            ((c.style.minWidth = J + "px"), (c.style.left = ve + "px"));
          } else {
            const y = O.right - Z.right,
              T = window.innerWidth - U.right - y,
              X = window.innerWidth - P.right - T,
              J = P.width + X,
              he = Math.max(J, O.width),
              ge = window.innerWidth - A,
              ve = Ne(T, [A, Math.max(A, ge - he)]);
          ...
          if (I <= te) {
            ...
            c.style.bottom = "0px";
            const T = p.clientHeight - u.offsetTop - u.offsetHeight,
              X = Math.max(le, re + (y ? me : 0) + T + D),
              J = I + X;
            c.style.height = J + "px";
          } else {
    ...
    return a.jsx(ro, {
      ...
      children: a.jsx(ie.ItemSlot, {
        ...
        children: a.jsx(_.div, {
          ...
          ...l,
          ref: C,
          onFocus: N(l.onFocus, () => b(!0)),
          onBlur: N(l.onBlur, () => b(!1)),
          onClick: N(l.onClick, () => {
            h.current !== "mouse" && S();
          }),
          ...
          onKeyDown: N(l.onKeyDown, (m) => {
            (i.searchRef?.current !== "" && m.key === " ") ||
              (Ut.includes(m.key) && S(), m.key === " " && m.preventDefault());
          }),
        }),
      }),
    });
...
var se = "SelectItemText",
  Ye = n.forwardRef((t, o) => {
    const { __scopeSelect: e, className: s, style: r, ...d } = t,
      ...
      b = g?.textContent,
      C = n.useMemo(
        () => a.jsx("option", { value: i.value, disabled: i.disabled, children: b }, i.value),
...
var Ce = "SelectArrow",
  ao = n.forwardRef((t, o) => {
    const { __scopeSelect: e, ...s } = t,
      ...
      d = Y(Ce, e),
      l = q(Ce, e);
    return d.open && l.position === "popper" ? a.jsx(Rt, { ...r, ...s, ref: o }) : null;
  });
ao.displayName = Ce;
...
const To = io,
  No = uo,
  vo = n.forwardRef(({ className: t, children: o, ...e }, s) =>
    a.jsxs(st, {
      ref: s,
      className: G(
      ...
      children: [
        o,
        a.jsx(po, { asChild: !0, children: a.jsx(Ee, { className: "h-4 w-4 opacity-50" }) }),
      ],
    }),
  );
vo.displayName = st.displayName;
const pt = n.forwardRef(({ className: t, ...o }, e) =>
  a.jsx(it, {
    ref: e,
    className: G("flex cursor-default items-center justify-center py-1", t),
    ...o,
    children: a.jsx(Mt, { className: "h-4 w-4" }),
  }),
);
...
const xo = n.forwardRef(({ className: t, children: o, position: e = "popper", ...s }, r) =>
  a.jsx(fo, {
    children: a.jsxs(at, {
      ref: r,
      className: G(
...
const wo = n.forwardRef(({ className: t, children: o, ...e }, s) =>
  a.jsxs(ct, {
    ref: s,
    className: G(
    ...
    children: [
      a.jsx("span", {
        ...
        children: a.jsx(go, { children: a.jsx(Pt, { className: "h-4 w-4" }) }),
      }),
      a.jsx(ho, { children: o }),
    ],
  }),
...
const yo = n.forwardRef(({ className: t, ...o }, e) =>
  a.jsx(ut, { ref: e, className: G("-mx-1 my-1 h-px bg-muted", t), ...o }),
);
yo.displayName = ut.displayName;
export { To as S, xo as a, wo as b, vo as c, No as d };
