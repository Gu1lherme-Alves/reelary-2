...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plataforma SaaS para agendar Reels do Instagram. Conecte sua conta, faça upload do vídeo e deixe que publicamos para você." },
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section className="mx-auto max-w-4xl px-6 pt-24 pb-20 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold leading-[1.05] tracking-tight">
          Agende seus <span className="text-gradient-brand">Reels</span><br />sem abrir o Instagram.
        </h1>
        <p className="mt-6 text-lg text-muted-foreground max-w-xl mx-auto">
          Conecte sua conta, faça upload do vídeo, escolha a hora — e a gente publica.
          Calendário de conteúdo profissional para criadores que vivem de Reels.
        </p>
        ...
        <div className="mt-24 grid gap-4 md:grid-cols-3 text-left">
          {[
            { icon: Instagram, title: "Conecte em 1 clique", desc: "Login direto via Meta. Sem complicações." },
            { icon: CalendarClock, title: "Calendário inteligente", desc: "Visualize, edite e reorganize tudo." },
            { icon: Zap, title: "Publicação automática", desc: "Configure e esqueça. Publicamos por você." },
          ].map((f) => (
            <div key={f.title} className="rounded-2xl border border-border/60 bg-card/50 p-6 backdrop-blur shadow-card">
